...
layout(set = 0, binding = 0, std430) readonly buffer XeTextureBlitScratchSource {
  uint xe_texture_blit_scratch_source[];
};

layout(set = 0, binding = 1, r32ui) uniform writeonly uimage2DArray
...
void main() {
  ...
  uint value = xe_texture_blit_scratch_source[
