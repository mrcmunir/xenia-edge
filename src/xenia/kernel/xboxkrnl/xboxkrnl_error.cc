...
constexpr uint32_t error_table_0x00000103[] = {
    X_ERROR_IO_PENDING,  // X_STATUS_PENDING
    0,                   //
...
constexpr uint32_t error_table_0x40000002[] = {
    X_ERROR_INVALID_PARAMETER,  // 0x40000002
    0,                          //
    0,                          //
    0,                          //
...
constexpr uint32_t error_table_0x80000001[] = {
    ...
    X_ERROR_NO_MORE_FILES,  // 0x80000006
    0,                      //
    0,                      //
    0,                      //
    0,                      //
...
constexpr uint32_t error_table_0x80090300[] = {
    ...
    X_ERROR_INVALID_HANDLE,       // 0x80090301
    ...
    X_ERROR_INVALID_PARAMETER,    // 0x80090308
    X_ERROR_INVALID_PARAMETER,    // 0x80090309
    X_ERROR_NOT_SUPPORTED,        // 0x8009030A
    0x00000558,                   // 0x8009030B
    0x0000052E,                   // 0x8009030C
    X_ERROR_INVALID_PARAMETER,    // 0x8009030D
    0x00000520,                   // 0x8009030E
    X_ERROR_ACCESS_DENIED,        // 0x8009030F
    X_ERROR_ACCESS_DENIED,        // 0x80090310
    ...
    0,                            //
    0,                            //
    X_ERROR_INVALID_PARAMETER,    // 0x80090320
    X_ERROR_INSUFFICIENT_BUFFER,  // 0x80090321
    0x00000574,                   // 0x80090322
    0,                            //
    0,                            //
    0x000006FE,                   // 0x80090325
    X_ERROR_INVALID_PARAMETER,    // 0x80090326
    X_ERROR_INVALID_PARAMETER,    // 0x80090327
...
constexpr uint32_t error_table_0xC0000001[] = {
    ...
    X_ERROR_INVALID_PARAMETER,     // X_STATUS_INVALID_INFO_CLASS
    0x00000018,                    // 0xC0000004
    0x000003E6,                    // 0xC0000005
    0x000003E7,                    // 0xC0000006
    0x000005AE,                    // 0xC0000007
    X_ERROR_INVALID_HANDLE,        // X_STATUS_INVALID_HANDLE
    0x000003E9,                    // 0xC0000009
    0x000000C1,                    // 0xC000000A
    X_ERROR_INVALID_PARAMETER,     // 0xC000000B
    0,                             //
    X_ERROR_INVALID_PARAMETER,     // X_STATUS_INVALID_PARAMETER
    X_ERROR_FILE_NOT_FOUND,        // 0xC000000E
    X_ERROR_FILE_NOT_FOUND,        // X_STATUS_NO_SUCH_FILE
    ...
    X_ERROR_NOT_ENOUGH_MEMORY,     // X_STATUS_NO_MEMORY
    0x000001E7,                    // 0xC0000018
    0x000001E7,                    // 0xC0000019
    X_ERROR_INVALID_PARAMETER,     // 0xC000001A
    X_ERROR_INVALID_PARAMETER,     // 0xC000001B
    0x00000001,                    // 0xC000001C
    0xC000001D,                    // 0xC000001D
    X_ERROR_ACCESS_DENIED,         // 0xC000001E
    X_ERROR_ACCESS_DENIED,         // 0xC000001F
    0x000000C1,                    // 0xC0000020
    X_ERROR_ACCESS_DENIED,         // X_STATUS_ALREADY_COMMITTED
    X_ERROR_ACCESS_DENIED,         // X_STATUS_ACCESS_DENIED
    X_ERROR_INSUFFICIENT_BUFFER,   // X_STATUS_BUFFER_TOO_SMALL
    X_ERROR_INVALID_HANDLE,        // X_STATUS_OBJECT_TYPE_MISMATCH
    ...
    0,                             //
    0,                             //
    X_ERROR_INVALID_PARAMETER,     // 0xC0000030
    0,                             //
    0x00000571,                    // 0xC0000032
    X_ERROR_INVALID_NAME,          // X_STATUS_OBJECT_NAME_INVALID
    X_ERROR_FILE_NOT_FOUND,        // X_STATUS_OBJECT_NAME_NOT_FOUND
    X_ERROR_ALREADY_EXISTS,        // X_STATUS_OBJECT_NAME_COLLISION
    0,                             //
    X_ERROR_INVALID_HANDLE,        // 0xC0000037
    0,                             //
    0x000000A1,                    // 0xC0000039
    X_ERROR_PATH_NOT_FOUND,        // X_STATUS_OBJECT_PATH_NOT_FOUND
    0x000000A1,                    // 0xC000003B
    0x0000045D,                    // 0xC000003C
    0x0000045D,                    // 0xC000003D
    0x00000017,                    // 0xC000003E
    0x00000017,                    // 0xC000003F
    X_ERROR_NOT_ENOUGH_MEMORY,     // 0xC0000040
    X_ERROR_ACCESS_DENIED,         // 0xC0000041
    X_ERROR_INVALID_HANDLE,        // 0xC0000042
    0x00000020,                    // 0xC0000043
    0x00000718,                    // 0xC0000044
    X_ERROR_INVALID_PARAMETER,     // X_STATUS_INVALID_PAGE_PROTECTION
    0x00000120,                    // 0xC0000046
    0x0000012A,                    // 0xC0000047
    X_ERROR_INVALID_PARAMETER,     // 0xC0000048
    X_ERROR_INVALID_PARAMETER,     // 0xC0000049
    0x0000009C,                    // 0xC000004A
    X_ERROR_ACCESS_DENIED,         // X_STATUS_THREAD_IS_TERMINATING
    X_ERROR_INVALID_PARAMETER,     // 0xC000004C
    X_ERROR_INVALID_PARAMETER,     // 0xC000004D
    X_ERROR_INVALID_PARAMETER,     // 0xC000004E
    ...
    X_ERROR_ACCESS_DENIED,         // 0xC0000056
    X_ERROR_NOT_SUPPORTED,         // 0xC0000057
    ...
    X_ERROR_NO_SUCH_USER,          // 0xC0000064
    ...
    X_ERROR_NOT_ENOUGH_MEMORY,     // 0xC0000097
    0x000003EE,                    // 0xC0000098
    0x00000540,                    // 0xC0000099
    0x000005AA,                    // 0xC000009A
    X_ERROR_PATH_NOT_FOUND,        // 0xC000009B
    0x00000017,                    // 0xC000009C
    X_ERROR_DEVICE_NOT_CONNECTED,  // 0xC000009D
    ...
    X_ERROR_INVALID_PARAMETER,     // 0xC00000A9
    0,                             //
    ...
    0,                             //
    0,                             //
    X_ERROR_ACCESS_DENIED,         // X_STATUS_FILE_IS_A_DIRECTORY
    X_ERROR_NOT_SUPPORTED,         // X_STATUS_NOT_SUPPORTED
    ...
    X_ERROR_ACCESS_DENIED,         // 0xC00000D5
    ...
    X_ERROR_INVALID_PARAMETER,     // X_STATUS_INVALID_PARAMETER_1
    X_ERROR_INVALID_PARAMETER,     // X_STATUS_INVALID_PARAMETER_2
    X_ERROR_INVALID_PARAMETER,     // X_STATUS_INVALID_PARAMETER_3
    X_ERROR_INVALID_PARAMETER,     // 0xC00000F2
    X_ERROR_INVALID_PARAMETER,     // 0xC00000F3
    X_ERROR_INVALID_PARAMETER,     // 0xC00000F4
    X_ERROR_INVALID_PARAMETER,     // 0xC00000F5
    X_ERROR_INVALID_PARAMETER,     // 0xC00000F6
    X_ERROR_INVALID_PARAMETER,     // 0xC00000F7
    X_ERROR_INVALID_PARAMETER,     // 0xC00000F8
    X_ERROR_INVALID_PARAMETER,     // 0xC00000F9
    X_ERROR_INVALID_PARAMETER,     // 0xC00000FA
    X_ERROR_PATH_NOT_FOUND,        // 0xC00000FB
    0,                             //
    ...
    X_ERROR_ACCESS_DENIED,         // X_STATUS_PROCESS_IS_TERMINATING
    ...
    X_ERROR_INVALID_PARAMETER,     // 0xC0000182
...
constexpr uint32_t error_table_0xC0000202[] = {
    ...
    X_ERROR_NOT_SUPPORTED,   // 0xC0000216
    X_ERROR_NOT_SUPPORTED,   // 0xC0000217
    0,                       //
    0,                       //
    0,                       //
    0,                       //
    ...
    X_ERROR_NOT_FOUND,       // X_STATUS_NOT_FOUND
    0,                       //
    0,                       //
    0,                       //
    0,                       //
    ...
    X_ERROR_INVALID_HANDLE,  // 0xC0000235
    ...
    0,                       //
    0,                       //
    X_ERROR_ACCESS_DENIED,   // 0xC000028A
    X_ERROR_ACCESS_DENIED,   // 0xC000028B
    0,                       //
    X_ERROR_ACCESS_DENIED,   // 0xC000028D
    X_ERROR_ACCESS_DENIED,   // 0xC000028E
    X_ERROR_ACCESS_DENIED,   // 0xC000028F
    X_ERROR_ACCESS_DENIED,   // 0xC0000290
...
constexpr uint32_t error_table_0xC0020001[] = {
    ...
    X_ERROR_INVALID_HANDLE,  // 0xC0020003
...
constexpr uint32_t error_table_0xC0030001[] = {
    ...
    X_ERROR_INVALID_HANDLE,  // 0xC0030004
    X_ERROR_INVALID_HANDLE,  // 0xC0030005
